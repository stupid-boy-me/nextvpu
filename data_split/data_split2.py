...
def data_set_split(src_data_folder, target_data_folder, train_scale=0.7, val_scale=0.2, test_scale=0.1):
    ...
    json_str = json.dumps(dict((val, key) for key, val in class_indices.items()), indent=2)
    with open('/algdata01/yiguo.huang/yanye/test6mobilenet/Data/data20230103_class_2_B03_F03/class.json', 'w') as json_file:
